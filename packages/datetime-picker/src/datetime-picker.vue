...
<script type="text/babel">
  import picker from 'fx-mui/packages/picker/index.js';
  import popup from 'fx-mui/packages/popup/index.js';
  if (process.env.NODE_ENV === 'component') {
    require('fx-mui/packages/picker/style.css');
    require('fx-mui/packages/popup/style.css');
  }
