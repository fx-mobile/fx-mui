...
<script>
import { once } from 'fx-mui/src/utils/dom';
import XCell from 'fx-mui/packages/cell/index.js';
import Clickoutside from 'fx-mui/src/utils/clickoutside';
if (process.env.NODE_ENV === 'component') {
  require('fx-mui/packages/cell/style.css');
}
